> **Archived 2026-09-24.** This is the handoff from the retired pure-Python
> direction. It is kept for its file map, reverse-engineering notes and
> validation workflow, which still apply. Its speed statements are wrong (see
> `POSTMORTEM_2026-09-24_pure_python_single_file.md`). The current handoff, for
> the tttk integration, is `HANDOFF.md`.
